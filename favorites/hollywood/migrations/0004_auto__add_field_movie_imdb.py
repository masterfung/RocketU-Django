...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movie.imdb'
        db.add_column(u'hollywood_movie', 'imdb',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 7, 2, 0, 0), max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movie.imdb'
        db.delete_column(u'hollywood_movie', 'imdb')
