...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tomatoes_movie', (
            ...
            ('critics_score', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('poster', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('mpaa_rating', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('runtime', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('audience_score', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True)),
        ))
